...
#include <map>  // like hash map in Java
#include <string>

class KeyPair{
    private:
    std::string VKName; //Physical key pressed
    std::string Name;   //Key printed on screen by user depending on language plaftform
public:
    KeyPair(const std::string &vk="" , const std::string &name=""): VKName(vk) , Name(name) {}; //represents pairs
